...
class CardPaymentConfigurator implements PaymentIntentPaymentConfigurator
{
    ...
    public function configure(
        ...
        $cookieCardOption = json_decode($_COOKIE["card"]);
        $paymentMethodID = $selectedCard['id'] ?? $cookieCardOption->card->id;
        ...
        $paymentIntentConfig->setStripePaymentMethodId($paymentMethodID);
